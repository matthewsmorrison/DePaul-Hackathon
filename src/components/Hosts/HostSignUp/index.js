...
class HostSignUpPageBase extends Component {
  constructor(props) {
    ...
    if(this.state.stage === 0) {
      return (
        ...
        <div className="w-md-75 w-lg-50 mx-md-auto">
            <div className="mb-7">
              <h1 className="h3 text-primary font-weight-normal mb-4">Sign up to Become a Stopover Host</h1>
...
const HostSignUpPage = compose(withRouter, withFirebase,)(HostSignUpPageBase);
