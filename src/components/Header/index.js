          ...
          <div className="u-header__section">
            ...
            <div id="logoAndNav" className="container">
              <nav className="js-mega-menu navbar navbar-expand-md u-header__navbar">
                <Link to="/" className="navbar-brand u-header__navbar-brand u-header__navbar-brand-top-space" aria-label="Front"><img src="../../assets/svg/logos/logo.png" style={{width:"90%"}} alt="Logo"></img></Link>
              ...
              <nav className="js-mega-menu navbar navbar-expand-md u-header__navbar">
                ...
                <div id="navBar" className="collapse navbar-collapse py-0">
                  ...
                  <li className="nav-item u-header__nav-item"
                    ...
                    data-animation-in="slideInUp"
                    data-animation-out="fadeOut">
                  <a href="/signin" id="blogMegaMenu" className="nav-link u-header__nav-link">
                    Sign-In
                    <span className="fa u-header__nav-link-icon"></span>
                  </a>
                 </li>
